<h1 align="center">Привет, я <a href="https://t.me/Whatmeanbetter" target="_blank">Алексей Кузнецов</a>
<img src="https://github.com/blackcater/blackcater/raw/main/images/Hi.gif" height="32"/></h1>

<h3 align="center">Industrial Python Developer • Computer Vision • Automation Engineer</h3>
<h4 align="center">Миграция VBA → Python | Пайплайны данных | CV/ML в реальных задачах</h4>
...
- Оффлайн-трекинг (Norfair + Re-ID) → точность >94%  
- Использовался в реальной экспедиции на Байкале

### Система поиска людей с дронов (МЧС / Лиза Алерт)
Автоматическая обработка DJI видео + SRT → карта с таймкодами и координатами за 5 минут вместо 3 часов
...
![Ultralytics](https://img.shields.io/badge/Ultralytics_YOLO-000000?style=for-the-badge&logo=yolo&logoColor=white)
...
- Computer Vision в промышленных и спасательных задачах  
- FastAPI + PostgreSQL + Docker проекты
...
> Делаю так, чтобы данные работали на людей, а не люди на данные.

<img src="https://user-images.githubusercontent.com/74038190/212284100-361c3c49-5e00-4a93-9f0d-0f0d1f3b4d6f.gif" width="100%"/>
